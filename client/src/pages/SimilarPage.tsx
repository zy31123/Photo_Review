  ...
  if (status === 'idle' && groups.length === 0) {
    return (
      <div className="h-screen flex flex-col bg-bg">
        ...
        <SimilarToolbar />
        <div className="flex-1 flex flex-col items-center justify-center">
          <div className="w-16 h-16 rounded-2xl bg-fill-subtle flex items-center justify-center mb-5">
          ...
          <p className="text-text text-title-2 font-semibold mb-1.5">相似照片聚类</p>
          <p className="text-text-secondary text-caption">点击上方「分析相似照片」开始检测连拍和相似图片</p>
        </div>
      </div>
    )
  }
