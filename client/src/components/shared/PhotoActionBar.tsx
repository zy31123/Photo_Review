import { ChevronLeft, ChevronRight, Heart, X, Check } from 'lucide-react'
...
export default function PhotoActionBar({
  ...
  onPrev, onNext, onDelete, onKeep, onRating, onFavorite,
  children,
}: PhotoActionBarProps) {
  return (
    <div className="absolute bottom-5 left-1/2 -translate-x-1/2 z-10">
      <div className="flex items-center gap-3 bg-[#1D1D1F]/90 backdrop-blur-2xl rounded-2xl px-4 py-2.5 shadow-[0_4px_24px_rgba(0,0,0,0.3)]">
        ...
        <ActionBtn onClick={onFavorite} label={favorite ? '取消收藏' : '收藏'} shortcut="F">
